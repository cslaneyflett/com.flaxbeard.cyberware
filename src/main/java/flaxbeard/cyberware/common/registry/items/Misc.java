...
public class Misc extends ItemRegistry
{
	...
	public static final RegistryObject<ItemExpCapsule> EXP_CAPSULE =
		register("exp_capsule", () -> new ItemExpCapsule(new Item.Properties().tab(CWCreativeTabs.CYBERWARE)));
	public static final RegistryObject<ItemBlueprint> BLUEPRINT =
		register("blueprint", () -> new ItemBlueprint(new Item.Properties().tab(CWCreativeTabs.CYBERWARE)));
	public static final RegistryObject<ItemSwordCyberware> KATANA =
		register("katana", () -> new ItemSwordCyberware(CWTiers.KATANA, 0, 0.0F, new Item.Properties().tab(CWCreativeTabs.CYBERWARE)));
}
