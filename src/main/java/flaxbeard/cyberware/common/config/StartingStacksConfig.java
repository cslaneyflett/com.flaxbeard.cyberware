...
//		{
//			BodyRegionEnum slot = BodyRegionEnum.values()[index];
...
//	}
	...
	public static NonNullList<ItemStack> getStartingItems(@Nonnull BodyRegionEnum slot)
	{
...
//		config = new ForgeConfigSpec.Builder();
		startingItems = defaultStartingItems = new String[BodyRegionEnum.values().length][0];
		...
		// TODO
//		int metadata = 0;
//		for (int index = 0; index < BodyRegionEnum.values().length; index++)
//		{
//			if (BodyRegionEnum.values()[index].hasEssential())
//			{
//				if (BodyRegionEnum.values()[index].isSided())
//				{
