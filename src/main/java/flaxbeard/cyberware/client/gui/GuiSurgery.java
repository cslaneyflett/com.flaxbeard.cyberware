...
public class GuiSurgery // extends GuiContainer
{
	...
	//		}
	//
	//		private PageConfiguration(float rotation, float x, float y, float scale, float boxWidth, float boxHeight,
	...
	//	}
	//
	//	private static final ResourceLocation SURGERY_GUI_TEXTURES = new ResourceLocation(Cyberware.MODID + ":textures/gui" +
	//		"/surgery.png");
	//	private static final ResourceLocation GREY_TEXTURE = new ResourceLocation(Cyberware.MODID + ":textures/gui/greypx" +
	//		".png");
	//	private static final ResourceLocation BLUE_TEXTURE = new ResourceLocation(Cyberware.MODID + ":textures/gui/bluepx" +
	//		".png");
	...
	//			(int) configs[0].boxWidth, (int) configs[0].boxHeight
	//		)); // CAW
	//
	...
	//		}
	//
	//		transitionStart = tickCount() + partialTicks;
	//
	//		current = ease;
	...
	//		int criticalEssence = (int) ((CyberwareConfig.INSTANCE.CRITICAL_ESSENCE.get() * 1F / surgery.maxEssence) * 49);
	...
	//		{
	//			float trans = 1.0F - ((tickCount() + partialTicks) - surgery.ticksWrong) / 10F;
	//			if (trans > 0)
	//			{
	//				GlStateManager.color(1.0F, 1.0F, 1.0F, trans);
	//
	//				Slot slot = inventorySlots.inventorySlots.get(surgery.wrongSlot);
	//				drawTexturedModalRect(xLeft + slot.xPos - 5, yTop + slot.yPos - 5, 185, 61, 26, 26);        // Blue
	//				// slot
	//			} else
	//			{
	//				surgery.wrongSlot = -1;
	...
	//			drawTexturedModalRect(xLeft + 5, yTop + 5 + (49 - essence), 176, 61 + (49 - essence), 9, Math.max(
	//				0,
	//				essence - warningEssence
	//			));
	//
	//			drawTexturedModalRect(xLeft + 5, yTop + 5 + (49 - Math.min(warningEssence, essence)), 229,
	//				61 + (49 - Math.min(warningEssence, essence)), 9, Math.max(
	//					0,
	//					Math.min(
	//						warningEssence,
	//						essence
	...
	//			);
	//
	//			drawTexturedModalRect(xLeft + 5, yTop + 5 + (49 - Math.min(criticalEssence, essence)), 220,
	//				61 + (49 - Math.min(criticalEssence, essence)), 9, Math.max(
	//					0,
	//					Math.min(criticalEssence
	//						, essence)
	//				)
	//			);
	//
	...
	//				for (int h = 0; h < 5; h++)
	//				{
	//					drawTexturedModalRect(xLeft + (20 * w + 9) - 1, yTop + (20 * h + 50) - 1 - 26, 176,
	//						indexNews[w + h * 8] == 2 ? 18 : 43, 18, 18
	//					);
	//				}
	//			}
	//
	...
	//				for (int h = 0; h < 5; h++)
	//				{
	//					drawTexturedModalRect(xLeft + (20 * w + 9) - 1, yTop + (20 * h + 50) - 1 - 26, 176 + 18,
	//						indexNews[w + h * 8] == 2 ? 18 : 43, 18, 18
	//					);
	//				}
	//			}
	...
	//			drawTexturedModalRect(xLeft + pos.xPos - 1, yTop + pos.yPos - 1 - 26, 176 + 18, 18, 18, 18);    // Red
	//			// 'slot'
	//		}
	//
	...
	//			{
	//				missingSlots.add(I18n.get("cyberware.gui.noEssence"));
	//			} else if (surgery.essence < CyberwareConfig.INSTANCE.CRITICAL_ESSENCE.get())
	//			{
	//				missingSlots.add(I18n.get("cyberware.gui.criticalEssence"));
	//			}
	//
	//			if (surgery.missingPower)
	//			{
	//				missingSlots.add(I18n.get("cyberware.gui.noPower"));
	//			}
	//
	//
	...
	//						{
	//							missingSlots.add(I18n.get("cyberware.gui.missingEssential." + slot.getName() + ".left"));
	//						}
	//					} else
	//					{
	//						if (surgery.isEssentialMissing[index])
	//						{
	//							missingSlots.add(I18n.get("cyberware.gui.missingEssential." + slot.getName() + ".right"));
	//						}
	//					}
	//				} else if (index % 2 == 0)
	//				{
	//					if (surgery.isEssentialMissing[index])
	//					{
	//						missingSlots.add(I18n.get("cyberware.gui.missingEssential." + slot.getName()));
	//					}
	//				}
	//			}
	//
	...
	//		float time = tickCount() + partialTicks;
	//
	...
	//					&& page < 10)
	//				{
	//					addedRotate = (addedRotate + (tickCount() + partialTicks - lastTicks) * 2f) % 360;
	//				}
	//				lastTicks = tickCount() + partialTicks;
	//				renderModel(box,
	...
	//
	//			entityPlayer.renderYawOffset = entityPlayer.rotationYaw = entityPlayer.rotationPitch =
	...
	//	{
	//		return mc.player != null ? Minecraft.getInstance().player.tickCount : 0;
	//	}
	//
	...
	//		if (page == 9)
	//		{
	//			String s = I18n.get("cyberware.gui.installed");
	...
	//				&& stack.getCount() > 1)
	//			{
	//				Font fontRenderItem = stack.getItem().getFontRenderer(stack);
	//				if (fontRenderItem == null) fontRenderItem = fontRenderer;
	//
	//				itemRender.renderItemOverlayIntoGUI(fontRenderItem, stack, pos.xPos, pos.yPos - 26,
	...
	//					if (fontRenderItem == null) fontRenderItem = fontRenderer;
	//
	//					itemRender.renderItemOverlayIntoGUI(fontRenderItem, stack, pos.xPos, pos.yPos,
	//						Integer.toString(stack.getCount())
	//					);
	//				}
	//
	...
	//				int width = pos.getStack().getCount() == 1 ? 0 :
	//					fontRenderItem.getStringWidth(Integer.toString(pos.getStack().getCount()));
	//
	...
	//
	//				Font fontRendererItem = draw.getItem().getFontRenderer(draw);
	//				if (fontRendererItem == null) fontRendererItem = fontRenderer;
	//
	//				if (!draw.isEmpty()
	//					&& draw.getCount() > 1)
	//				{
	//					itemRender.renderItemOverlayIntoGUI(fontRendererItem, draw, x, y,
	//						Integer.toString(draw.getCount())
	//					);
	//				}
	//
	...
	//			if (surgery.essence < 0)
	//			{
	//				missingSlots.add(I18n.get("cyberware.gui.no_essence"));
	//			} else if (surgery.essence < CyberwareConfig.INSTANCE.CRITICAL_ESSENCE.get())
	//			{
	//				missingSlots.add(I18n.get("cyberware.gui.critical_essence"));
	//			}
	//
	//			if (surgery.missingPower)
	//			{
	//				missingSlots.add(I18n.get("cyberware.gui.no_power"));
	//			}
	//
	//			for (int index = 0; index < surgery.isEssentialMissing.length; index++)
	//			{
	...
	//						if (surgery.isEssentialMissing[index])
	//						{
	//							missingSlots.add(I18n.get("cyberware.gui.missing_essential." + slot.getName() + ".left"));
	//						}
	//					} else
	//					{
	//						if (surgery.isEssentialMissing[index])
	//						{
	//							missingSlots.add(I18n.get("cyberware.gui.missing_essential." + slot.getName() + ".right"));
	//						}
	//					}
	//				} else if (index % 2 == 0)
	//				{
	//					if (surgery.isEssentialMissing[index])
	//					{
	//						missingSlots.add(I18n.get("cyberware.gui.missing_essential." + slot.getName()));
	//					}
	//				}
	//			}
	//
	...
	//				if (add)
	//				{
	//					drawHoveringText(Collections.singletonList(I18n.get(
	//							"cyberware.gui.add",
	//							I18n.get(stack.getTranslationKey() + ".name")
	//						)),
	...
	//					{
	//						parent = index.id;
	//						int time = GameSettings.isKeyDown(mc.options.keyBindSneak) ? 0 : 30;
	...
	//		{
	//			drawHoveringText(Collections.singletonList(I18n.get("cyberware.gui.back")),
	//				mouseX - xLeft, mouseY - yTop, fontRenderer
	//			);
	//		} else if (page == 0
	//			&& isPointInRegion(xSize - 22, 5, index.width, index.height, mouseX, mouseY))
	//		{
	//			drawHoveringText(Collections.singletonList(I18n.get("cyberware.gui.index")),
	//				mouseX - xLeft, mouseY - yTop, fontRenderer
	//			);
	//		}
	//
	...
	//				{
	//					if (!surgery.doesItemConflict(playerSlotItem, ((SlotSurgery) slotIn).slot,
	//						number % LibConstants.WARE_PER_SLOT
	//					))
	//					{
	//						surgerySlot.setDiscarded(false);
	//						surgery.enableDependsOn(playerSlotItem, ((SlotSurgery) slotIn).slot,
	//							number % LibConstants.WARE_PER_SLOT
	//						);
	//						CyberwarePacketHandler.INSTANCE.sendToServer(new SurgeryRemovePacket(surgery.getPos(),
	//							surgery.getLevel().provider.getDimension(), number, false
	//						));
	//					}
	//				} else
	//				{
	//					if (surgery.canDisableItem(playerSlotItem, ((SlotSurgery) slotIn).slot,
	//						number % LibConstants.WARE_PER_SLOT
	//					))
	//					{
	//						surgerySlot.setDiscarded(true);
	//						surgery.disableDependants(playerSlotItem, ((SlotSurgery) slotIn).slot,
	//							number % LibConstants.WARE_PER_SLOT
	//						);
	//						CyberwarePacketHandler.INSTANCE.sendToServer(new SurgeryRemovePacket(surgery.getPos(),
	//							surgery.getLevel().provider.getDimension(), number, true
	//						));
	//					}
	//				}
	//			}
	...
	//	{
	//		List<String> listTooltips = stack.getTooltip(mc.player, mc.options.advancedItemTooltips ?
	//			TooltipFlag.TooltipFlags.ADVANCED :
	//			TooltipFlag.TooltipFlags.NORMAL);
	//
	...
	//				listTooltips.set(
	//					indexTooltip,
	//					stack.getItem().getForgeRarity(stack).getColor() + listTooltips.get(indexTooltip)
	//				);
	//			} else
	//			{
	//				listTooltips.set(indexTooltip, ChatFormatting.GRAY + listTooltips.get(indexTooltip));
	//			}
	//		}
	//
	//		if (extras == 1)
	//		{
	//			listTooltips.add(1, I18n.get("cyberware.gui.remove"));
	//		} else if (extras >= 2)
	//		{
	//			listTooltips.add(1, I18n.get("cyberware.gui.click"));
	//
	//			if (extras == 3)
	//			{
	//				listTooltips.set(0, listTooltips.get(0) + " " + I18n.get("cyberware.gui.added"));
	//			} else if (extras == 4)
	//			{
	//				listTooltips.set(0, listTooltips.get(0) + " " + I18n.get("cyberware.gui.removed"));
	//			}
	//		}
	//
	//		Font frontRendererItem = stack.getItem().getFontRenderer(stack);
