...
public class GuiCyberwareMenu // extends Screen
{
	...
	//			}
	//
	//			ImmutableSet<KeyMapping> set = ImmutableSet.of(mc.options.keyBindForward, mc.options.keyBindLeft
	//				, mc.options.keyBindBack, mc.options.keyBindRight, mc.options.keyBindSneak,
	//				mc.options.keyBindSprint, mc.options.keyBindJump
	//			);
	...
	//			{
	//				KeyBinding kb = mc.options.keyBindsHotbar[i];
