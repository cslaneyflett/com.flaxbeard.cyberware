...
{
	//	public ContainerFineManipulators(Inventory playerInventory, boolean localWorld, Player entityPlayer)
	//	{
	...
	//			{
	//				addSlotToContainer(new Slot(craftMatrix, indexColumn + indexRow * 3, 30 + indexColumn * 18,
	//					17 + indexRow * 18
	//				));
	//			}
	//		}
	...
	//			{
	//				addSlotToContainer(new Slot(playerInventory, indexColumn + (indexRow + 1) * 9, 8 + indexColumn * 18,
	//					84 + indexRow * 18
	//				));
	//			}
	//		}
