...
public class ContainerSurgery // extends Container
{
	...
	//
	//	public ContainerSurgery(Inventory playerInventory, TileEntitySurgery surgery)
	//	{
	...
	//			{
	//				addSlotToContainer(new SlotSurgery(surgery.slots, surgery.slotsPlayer, indexContainerSlot,
	//					9 + 20 * indexCyberwareSlot, 109, slot
	//				));
	//				indexContainerSlot++;
	//			}
	...
	//			{
	//				addSlotToContainer(new SlotSurgery(surgery.slots, surgery.slotsPlayer, indexContainerSlot,
	//					Integer.MIN_VALUE, Integer.MIN_VALUE, slot
	//				));
	//				indexContainerSlot++;
	//			}
	//		}
