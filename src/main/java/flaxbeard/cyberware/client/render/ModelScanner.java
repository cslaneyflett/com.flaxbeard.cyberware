...
// TODO: mekanism render jetpack, multiple groups
public class ModelScanner // extends ModelBase
{
	...
	//	}
	//
	//	public void renderScanner(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks,
	//							  float netHeadYaw, float headPitch, float scale)
	//	{
	//		this.scanner.render(scale);
	//	}
	//
	//	public void renderBeam(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
	//						   float headPitch, float scale)
	//	{
