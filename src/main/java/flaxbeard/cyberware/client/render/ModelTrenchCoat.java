...
public class ModelTrenchCoat // extends HumanoidModel<LivingEntity>
{
	//	public LivingEntityRenderer<?, ModelTrenchCoat> bottomThing;
	//	private HumanoidModel<LivingEntity> modelBaseParent;
	//
	//	public ModelTrenchCoat(ModelPart pRoot)
	//	{
	//		super(pRoot);
